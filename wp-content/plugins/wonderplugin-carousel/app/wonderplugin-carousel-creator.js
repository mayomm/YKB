    ...
    $(document).ready(function() {
        ...
        var slideDialog = function(dialogType, onSuccess, data, dataIndex) {
            ...
            if (data) {
                ...
                if (data.displaythumbnail) $("#wonderplugin-dialog-displaythumbnail").attr("checked", true);
                else $("#wonderplugin-dialog-displaythumbnail").attr("checked", false);
                ...
                if (dialogType == 0) {
                    ...
                    if (data.weblinklightbox) $("#wonderplugin-dialog-weblinklightbox").attr("checked",
                        true);
                    else $("#wonderplugin-dialog-weblinklightbox").attr("checked", false);
            ...
            if (dialogType ==
                ...
                onlineVideoDialog(dialogType, function(items) {
                    items.map(function(data) {
                        wonderplugin_carousel_config.slides.push({
                            type: dialogType,
                            image: data.image,
                ...
                media_uploader.on("select", function(event) {
                    ...
                    if (dialogType == 0 && buttonId == "wonderplugin-dialog-select-image" && selection.length > 1) {
                        ...
                        selection.map(function(attachment) {
                            ...
                            else if (attachment.sizes && attachment.sizes.thumbnail && attachment.sizes.thumbnail.url) thumbnail =
        ...
        var onlineVideoDialog = function(dialogType, onSuccess, videoData, invokeFromSlideDialog, dataIndex) {
                ...
                slideDialog(dialogType, function(items) {
                    if (items && items.length > 0) {
                        ...
                        items.map(function(data) {
                            ...
                            if (typeof dataIndex !== "undefined" && dataIndex >= 0) wonderplugin_carousel_config.slides.splice(dataIndex, 0, result);
                            else wonderplugin_carousel_config.slides.push(result)
                        });
                        updateMediaTable()
                    }
                }, videoData, dataIndex)
            ...
            $("#wonderplugin-dialog-ok").click(function() {
                ...
                if (dialogType == 2) {
                    ...
                    videoData.video = result;
                    $("#wonderplugin-carousel-video-dialog-loading").css({
                        display: "block"
                    });
                    $.ajax({
                        url: protocol + "//www.vimeo.com/api/v2/video/" +
        ...
        $(document).on("click", ".wonderplugin-carousel-media-table-edit", function() {
            ...
            slideDialog(mediaType, function(items) {
                if (items && items.length > 0) {
                    ...
                    items.map(function(data) {
                        wonderplugin_carousel_config.slides.splice(index, 0, {
                            type: mediaType,
                            image: data.image,
                            thumbnail: data.thumbnail ? data.thumbnail : data.image,
                            displaythumbnail: data.displaythumbnail,
        ...
        var wonderPluginMediaTableMove = function(i, j) {
            ...
            if (j > len - 1) j = len - 1;
            if (i == j) {
                $("#wonderplugin-carousel-media-table").find("li").eq(i).find("img").css({
                    top: 0,
                    left: 0
                });
                return
        ...
        var printSkinOptions = function(options) {
            ...
            if (options.usescreenquery) $("input:radio[name=wonderplugin-carousel-usescreenquery][value=screensize]").attr("checked",
                true);
            else $("input:radio[name=wonderplugin-carousel-usescreenquery][value=fixedsize]").attr("checked", true);
        ...
        var updateCarouselOptions = function() {
            ...
            if ($("input[name=wonderplugin-carousel-usescreenquery]:checked").val() == "screensize") wonderplugin_carousel_config.usescreenquery =
                true;
            else wonderplugin_carousel_config.usescreenquery = false;
            ...
            if (wonderplugin_carousel_config.hoveroverlayimagemode == "custom") wonderplugin_carousel_config.hoveroverlayimage = $.trim($("#wonderplugin-carousel-customhoveroverlayimage").val());
            else wonderplugin_carousel_config.hoveroverlayimage = $.trim($("#wonderplugin-carousel-hoveroverlayimage").val());
            ...
            if (wonderplugin_carousel_config.navimagemode ==
                "custom") wonderplugin_carousel_config.navimage = $.trim($("#wonderplugin-carousel-customnavimage").val());
            else wonderplugin_carousel_config.navimage = $.trim($("#wonderplugin-carousel-navimage").val());
        ...
        var previewCarousel = function() {
            ...
            if (wonderplugin_carousel_config.slides.length > 0) {
                ...
                for (i = 0; i < wonderplugin_carousel_config.slides.length; i++) {
                    if (i == 0) code += '<li class="amazingcarousel-item">';
                    else if (i % wonderplugin_carousel_config.rownumber == 0) code += '</li><li class="amazingcarousel-item">';
                    code += '<div class="amazingcarousel-item-container">';
                    var image_code = "";
                    if (wonderplugin_carousel_config.slides[i].lightbox) {
                        image_code += '<a href="';
                        if (wonderplugin_carousel_config.slides[i].type == 0) image_code += wonderplugin_carousel_config.slides[i].image;
                        else if (wonderplugin_carousel_config.slides[i].type == 1) {
                    ...
                    if (wonderplugin_carousel_config.slides[i].displaythumbnail) image_code += '<img src="' + wonderplugin_carousel_config.slides[i].thumbnail + '"';
                    else image_code += '<img src="' + wonderplugin_carousel_config.slides[i].image + '"';
                    ...
                    if (!wonderplugin_carousel_config.slides[i].lightbox)
                        if (wonderplugin_carousel_config.slides[i].type == 1) {
                ...
                var carouselOptions = $.extend({}, WONDERPLUGIN_CAROUSEL_SKIN_OPTIONS[wonderplugin_carousel_config["skin"]], {
                ...
                if (carouselOptions.responsive) $("#wonderplugin-carousel-preview").css({
                    display: "none",
                    position: "relative",
                    width: "100%",
                    "max-width": totalwidth + "px"
                });
                else $("#wonderplugin-carousel-preview").css({
                    display: "none",
                    position: "relative",
                    width: totalwidth + "px"
                });
        ...
        var publishCarousel = function() {
            ...
            jQuery.ajax({
                ...
                type: "POST",
                data: {
                    action: "wonderplugin_carousel_save_config",
                    nonce: ajaxnonce,
        ...
        for (i = 0; i < boolOptions.length; i++)
            if (wonderplugin_carousel_config[boolOptions[i]] !== true && wonderplugin_carousel_config[boolOptions[i]] !== false) wonderplugin_carousel_config[boolOptions[i]] = wonderplugin_carousel_config[boolOptions[i]] && wonderplugin_carousel_config[boolOptions[i]].toLowerCase() ===
                "true";
