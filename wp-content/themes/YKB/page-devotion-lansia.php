<?php
/*
Template Name: Page Renungan Lansia
*/
get_header(); ?>
<?php session_start();
	$_SESSION["devotion"]="Renungan Lansia";
?>
			...
			<?php
				...
				<div class="devotion-content">
					<div id="img-content-top"class="col-md-14 img-devotion-content-top">
						<img src="<?php bloginfo('template_url'); ?>/images/devotion/Renungan Lansia.jpg" class="img-devotion-main">
					</div>
